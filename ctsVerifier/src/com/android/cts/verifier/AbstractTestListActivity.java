...
public abstract class AbstractTestListActivity extends ListActivity {
    ...
    protected com.android.cts.verifier.TestListAdapter mAdapter;
    ...
    protected void setTestListAdapter(com.android.cts.verifier.TestListAdapter adapter) {
        mAdapter = adapter;
    ...
    protected void handleLaunchTestResult(int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            com.android.cts.verifier.TestResult testResult = com.android.cts.verifier.TestResult.fromActivityResult(resultCode, data);
